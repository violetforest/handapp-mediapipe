workspace(name = "handapp-mediapipe")
...
# Note: this pulls the most recent android sdk from your $ANDROID_HOME
# https://docs.bazel.build/versions/master/be/android.html#android_sdk_repository
android_sdk_repository(
    name = "androidsdk",
    # TODO: Define Android SDK version / api level here 
)
...
git_repository(
    name="mediapipe",
    commit="39309bedba255aee2a4f31b29b65609857698ada",
...
maven_install(
    name = "maven",
    artifacts = [
        # Other maven dependencies can go here:

        # These are required by mediapipe
...
#########################################################################
######################## BEGIN EXTRA DEPS FOR MEDIAPIPE #################
#########################################################################
